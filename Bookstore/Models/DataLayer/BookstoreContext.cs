...
using Microsoft.AspNetCore.Identity; //Needed to inherit the identity DbContext
using Microsoft.AspNetCore.Identity.EntityFrameworkCore;
namespace Bookstore.Models
{
    public class BookstoreContext : IdentityDbContext<User> //Inherit
    {
        ...
        public static async Task CreateAdminUser(IServiceProvider serviceProvider)
        {
            ...
            string username = "admin"; //Default Credentials/Admin credentials 
